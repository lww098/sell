<template>
  <div class="ratingSelect">
    <div class="selectType">
      <span @click='select(2)' class="span all" :class="{'active':selectType===2}">{{desc.all}}
          <span class="count">{{ratings.length}}</span>
      </span>
      <span @click='select(0)' class="span positive" :class="{'active':selectType===0}">{{desc.positive}} 
          <span class="count">{{positive.length}}</span>
      </span>
      <span @click='select(1)' class="span negative" :class="{'active':selectType===1}">{{desc.negative}}
